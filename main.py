...
def start_insta_api():
    ...
    insta.app.run(host="0.0.0.0", port=10000, debug=False)
...
# IMPROVED TREE-STYLE HELP MENU SYSTEM (Commands in their original menus) 🌳
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = f"[b][c] Loading :-:"
                            await safe_send_message(response.Data.chat_type, header, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            #  Group Commands 
                            group_commands = """[C][B]
 [FFC107]Create 3-Player Group
   [3CB371]/3
 [FFC107]Create 5-Player Group
   [3CB371]/5
 [FFC107]Create 6-Player Group
   [3CB371]/6
 [FFC107]Invite Player
   [3CB371]/inv [uid]
 [FFC107]Join Team
   [3CB371]/join [team_code]
 [FFC107]Leave Group
   [3CB371]/exit
 [FFC107]Start Match
    [3CB371]/start
[FFC107]━━━━━━━━━━━━[FFC107]"""
                            ...
                            #  Advanced Commands 
                            advanced_commands = """[C][B]
 ⚡[FFC107]Spam Invites (30x)
   ⚡[3CB371]/spm_inv [uid]
 ⚡[FFC107]Stop Spam Invites
   ⚡[3CB371]/stop spm_inv
 ⚡[FFC107]Ghost Join Team
   ⚡[3CB371]/ghost [code]
 ⚡[FFC107]Lag Attack Team
   ⚡[3CB371]/lag [code]
 ⚡[FFC107]Stop Lag Attack
   ⚡[3CB371]/stop lag
 ⚡[FFC107]Reject Spam
    ⚡[3CB371]/reject [uid]
[FFC107]━━━━━━━━━━━━[3CB371]"""
                            ...
                            #  Emote Commands 
                            emote_commands = """[C][B]
 ⚡[FFC107]Send Single Emote
   ⚡[3CB371]/e [uid] [id]
 ⚡[FFC107]Fast Emote (25x)
   ⚡[3CB371]/fast [uid] [id]
 [FFC107]Custom Emote (X times)
    ⚡[3CB371]/p [uid] [id] [x]
[FFC107]━━━━━━━━━━━━[3CB371]"""
...
[FFC107]━━━━━━━━━━━━[FFA500]"""
                            ...
                            #  AI & Utility Commands 
                            ai_commands = """[C][B]
 ⚡[FFC107]Get player bio by uid
  ⚡[3CB371]/bio [uid]
 ⚡[FFC107]Fetch Instagram User Info
  ⚡[3CB371]/ig [username]
 ⚡[FFC107]Send custom spam message
 ⚡ [3CB371]/ms <text>
 ⚡[FFC107]Ask AI Anything
  ⚡[3CB371]/ai [question]
 ⚡[FFC107] DOCTOR STRANGE EMOTE
  ⚡[3CB371]/nm {uid}
 ⚡[FFC107]Bot Status Check
  ⚡ [3CB371]/status
[FFC107]━━━━━━━━━━━━[1E90FF]"""
                            ...
                            #  Badges Commands 
                            badge_commands = """[C][B]
 ⚡[FFC107]Join Req Craftland Badge
   ⚡[3CB371]/s1 [uid]
 ⚡[FFC107]Join Req New V-Badge
   ⚡[3CB371]/s2 [uid]
 ⚡[FFC107]Join Req Moderator Badge
   ⚡[3CB371]/s3 [uid]
 ⚡[FFC107]Join Req Small V-Badge
   ⚡[3CB371]/s4 [uid]
 ⚡[FFC107]Join Req Pro Badge
  ⚡[3CB371]/s5 [uid]
 ⚡[FFC107]Join Requests All Badge
    ⚡[3CB371]/spam [uid]
[FFC107]━━━━━━━━━━━━[3CB371]"""
                            ...
                            await asyncio.sleep(0.2)
                                                        ...
                                                        #  Auto Start Commands 
                            auto_commands = """[C][B][3CB371]═══⚡ AUTO START BOT ⚡═══[FFC107][B]
 ⚡[FFC107]Start level up bot (24x7)
   ⚡[3CB371]/level [team_code]
...
[FFC107]━━━━━━━━━━━━[3CB371]"""
                            ...
                            footer ="""[00FFFA]╔═•══•════════════════•══•═╗
[FFC107]║ ⚡ [B][FFFF00]BOT INFO[FFFF00][/B] ⚡
[00FFFA]║
[FFFF00]║ 👤 Developer    :: [FFC107]NoTmeowL CODEX
[3CB371]║ 💻 Status        :: [3CB371]ONLINE
[1E90FF]║ 🛠 Version      ::[3CB371]ENHANCED V2
[00FFFA]╚═•══•════════════════•══•═╝"""
...
async def MaiiiinE():
    Uid , Pw = '4357924270','M_TZ4KQ_BY_SPIDEERIO_GAMING_2CMRU'
